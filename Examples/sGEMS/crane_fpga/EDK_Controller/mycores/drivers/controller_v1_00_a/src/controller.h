/*****************************************************************************
* Filename:          C:\Users\asuardi\Desktop\CRANE_Vivado_HLS\EDK/drivers/controller_v1_00_a/src/controller.h
* Version:           1.00.a
...
#define CONTROLLER_SLV_REG3_OFFSET (CONTROLLER_USER_SLV_SPACE_OFFSET + 0x0000000C)

/**
 * Software Reset Space Register Offsets
 * -- RST : software reset register
 */
#define CONTROLLER_SOFT_RST_SPACE_OFFSET (0x00000100)
#define CONTROLLER_RST_REG_OFFSET (CONTROLLER_SOFT_RST_SPACE_OFFSET + 0x00000000)
...
#define CONTROLLER_mWriteSlaveReg3(BaseAddress, RegOffset, Value) \
 	Xil_Out32((BaseAddress) + (CONTROLLER_SLV_REG3_OFFSET) + (RegOffset), (Xuint32)(Value))
...
#define CONTROLLER_mReadSlaveReg3(BaseAddress, RegOffset) \
 	Xil_In32((BaseAddress) + (CONTROLLER_SLV_REG3_OFFSET) + (RegOffset))

/**
 *
 * Reset CONTROLLER via software.
 *
 * @param   BaseAddress is the base address of the CONTROLLER device.
 *
 * @return  None.
 ...
 * @note
 * C-style signature:
 * 	void CONTROLLER_mReset(Xuint32 BaseAddress)
 *
 */
#define CONTROLLER_mReset(BaseAddress) \
 	Xil_Out32((BaseAddress)+(CONTROLLER_RST_REG_OFFSET), SOFT_RESET)
